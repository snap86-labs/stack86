...
class CreateStack86 {
  private readonly templateRepo = "https://github.com/snap86-labs/stack86.git";
  private readonly templatePath = "templates/monorepo";
  ...
  private async scaffold(options: ScaffoldOptions) {
  ...
  private async replaceInFiles(dir: string, searchValue: string, replaceValue: string): Promise<void> {
  ...
  private async replaceInFile(filePath: string, searchValue: string, replaceValue: string): Promise<void> {
